...
import { FaCalendarAlt, FaCommentDots, FaEarlybirds, FaEnvelope, FaFacebook, FaFlag, FaInstagram, FaPhone, FaQuestionCircle, FaTextHeight, FaUserAlt } from "react-icons/fa";
...
const Contact = () => {
  ...
  const inputChange = e => setData(data => ({...data, [e.target.name]: e.target.type === 'checkbox' ? e.target.checked :  e.target.value}));
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="md:col-span-2 flex flex-col sm:flex-row items-center gap-2">
            <input type="file" accept="image/*" name="image" id="image" onChange={inputChange} className="w-full sm:w-auto"/>
          ...
          <div className="md:col-span-2 relative flex items-center gap-2">
            <input
              ...
              id="joinNewsLetter"
            />
            <label htmlFor="joinNewsLetter" >I'd like to join the club - exclusive discounts and news emailed to you!</label>
          </div>
